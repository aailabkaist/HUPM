...
pp.add_argument('--dataset', type=str, choices=['cifar', 'cars', 'cub2'], required=True)
...
# images = np.load(os.path.join(base_path, 'formatted_{}_images.npy'.format('train')))
# label_matrix = np.load(os.path.join(base_path, 'formatted_{}_labels_obs.npy'.format('train')))
# label_matrix1 = np.load(os.path.join(base_path, 'formatted_{}_labels_obs_1.npy'.format('train')))
# label_matrix2 = np.load(os.path.join(base_path, 'formatted_{}_labels_obs_2.npy'.format('train')))
# label_matrix3 = np.load(os.path.join(base_path, 'formatted_{}_labels_obs_3.npy'.format('train')))
# label_matrix4 = np.load(os.path.join(base_path, 'formatted_{}_labels_obs_4.npy'.format('train')))
# label_matrix5 = np.load(os.path.join(base_path, 'formatted_{}_labels_obs_5.npy'.format('train')))
#
#
# from collections import Counter
# print(Counter(GET(label_matrix1).tolist()))
# print(Counter(GET(label_matrix2).tolist()))
# print(Counter(GET(label_matrix3).tolist()))
# print(Counter(GET(label_matrix4).tolist()))
# print(Counter(GET(label_matrix5).tolist()))
# # print(images)
# exit()
...
for phase in ['train', 'val']:
    ...
    np.save(os.path.join(base_path, 'formatted_{}_labels_obs_{}.npy'.format(phase, args.seed)), label_matrix_obs)
